table 50015 "Posted Advance Header"
{
    fields
    {
        ...
        {
            Caption = 'Cash Count Before Replenish';
        }
        ...
        {
            OptionMembers = Unverified,"Pending Verification","Final Verified",Verified;
        }
        ...
        field(300; "Relational Voucher No."; Code[20])
        {
            Caption = 'Voucher No.';
        }
        field(301; "Vendor Name"; Text[100])
        {
        }
        field(302; "Vendor Bank Account Name"; Text[100])
        {
        }
        field(303; "Posted Status"; Option)
        {
            OptionMembers = Open,Released,"Pending Approval";
        }
        field(304; "Cash Count After Replenish"; Decimal)
        {
        }
        field(305; "Posted Submitted Date"; DateTime)
        {
        }
    ...
    var
        AdvanceLine: Record "Posted Advance Line";
